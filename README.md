...
This repository is the synthesis of a [series of posts](https://community.rstudio.com/t/legend-in-ggplot2/156765) published in [Posit Community](https://community.rstudio.com/). The objective was to recreate in `ggplot2` the presentation plot of the `showtext` R library, which uses the basic graphics functions of R. The original plot can be seen in the [repository](https://github.com/yixuan/showtext) of its author, [Yixuan Qiu](https://github.com/yixuan). The result is presented in the included R file `ggplot2_showtext.R` in this repository. Possibly there may be other simpler solutions than the ones I've found, I'll be happy to hear about them.
